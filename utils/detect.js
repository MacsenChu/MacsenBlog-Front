function DetectFactory (u) {
  const match = {
    ...
    'Mac OS X': u.indexOf('Macintosh') > -1,
  ...
  const hash = {
    ...
    os: ['Windows', 'Linux', 'Mac OS X', 'Android', 'Ubuntu', 'FreeBSD', 'Debian', 'iOS', 'Windows Phone', 'BlackBerry', 'MeeGo', 'Symbian', 'Chrome OS', 'WebOS'],
...
function detect () {
  return new DetectFactory(navigator.userAgent)
}
